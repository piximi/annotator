  ...
  return (
    <React.Fragment>
      ...
      <Typography>
        ...
        instance in an image is assigned a different (R, G, B) color in the
        exported mask), semantic segmentation masks (each category in an image
        is asssigned its corresponding (R, G, B) color in the exported mask), or
        label matrices.
      </Typography>
    </React.Fragment>
  );
